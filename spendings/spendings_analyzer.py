...
# andrey_checkpoint = sdr.read_cal_data("2022-09\\Transactions_11_09_2022 (2).xls")
# print(andrey_checkpoint)
# exit()
...
spendings = sdr.scan_folder_for_data("2022-09")
