...
class SpendingsCalculator:
    ...
    def calculate_spendings_per_category(self, spendings : pandas.DataFrame):
        total_spendings_sum = 0
        total_spendings_per_category = {}
        ...
        for row_iter in spendings.iterrows():
            ...
            total_spendings_sum = total_spendings_sum + spent_sum
        ...
        total_spendings.loc[total_spendings.shape[0]] = ["total", total_spendings_sum]
